            ...
            try {
                ...
                if (bookingDetails != null && rooms != null) {
                    ...
                    if (id > 0) {
                        ...
                        // Set active booking flag and store booking ID
                        request.getSession().setAttribute("activeBooking", true);
                        request.getSession().setAttribute("currentBookingId", id);
                        request.getSession().setAttribute("bookingCheckIn", bookingDetails.getCheckIn());
                        request.getSession().setAttribute("bookingCheckOut", bookingDetails.getCheckOut());
