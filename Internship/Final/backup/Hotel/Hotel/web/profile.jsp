                            ...
                            <table border="1" width="1" cellspacing="1" cellpadding="1" class="w-100 text-center">
                                ...
                                <tbody>
                                    <c:forEach var="serviceOrder" items="${serviceOrders}">
                                        <tr>
                                            <td>${serviceOrder.getOrderId()}</td>
                                            <td>${serviceOrder.getServiceName()}</td>
                                            <td>${serviceOrder.getQuantity()}</td>
                                            <td>${serviceOrder.getTotalPrice()}</td>
                                            <td>${serviceOrder.getOrderDate()}</td>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${serviceOrder.getStatus() == 'Completed'}">
                                                        <span class="text-success">Completed</span>
                                                    </c:when>
                                                    <c:when test="${serviceOrder.getStatus() == 'Cancelled'}">
                                                        <span class="text-danger">Cancelled</span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="text-warning">${serviceOrder.getStatus()}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                        </tr>
