...
public class ServicesOrderServlet extends HttpServlet {
    ...
    private void Payment(HttpServletRequest request, HttpServletResponse response, double price) throws IOException {
...
//            vnp_Params.put("vnp_BankCode", bankCode);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (null == vnp_ResponseCode) {
            ...
            switch (vnp_ResponseCode) {
                case "00":
                    try {
                        // Example: saving order, clearing cart, etc.
                        HttpSession session = request.getSession();
                        List<CartItem> cartItems = (List<CartItem>) session.getAttribute("cartItems");

                        if (cartItems != null && !cartItems.isEmpty()) {
                            // If needed: Save order to DB here
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Session cartItems: " + cartItems);
            ...
            Payment(request, response, servicePrice);
        } catch (Exception e) {
