...
public class BookingDAO {
    ...
    // Check to see if user has book a room or not in order to order bike rental service
...
// Check if rental date is within any of user's active booking periods
...
// Get all active bookings for a user (for more detailed validation)
