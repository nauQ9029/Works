<%-- 
    Document   : index
    Created on : Mar 20, 2025, 9:51:54 AM
    Author     : plmin
--%>
...
<html lang="en" data-bs-theme="dark"><head>
        ...
        <script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-W2VMDSX0CE&amp;cx=c&amp;_slc=1"></script><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <header class="navbar navbar-expand-lg bd-navbar sticky-top">
        <nav class="container-xxl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
            ...
            <div class="d-flex">
                <div class="bd-search" id="docsearch" data-bd-docs-version="5.3"><button type="button" aria-label="Search (Ctrl+K)" class="DocSearch DocSearch-Button"><span class="DocSearch-Button-Container"><svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" class="DocSearch-Search-Icon"><path d="M14.386 14.386l4.0877 4.0877-4.0877-4.0877c-2.9418 2.9419-7.7115 2.9419-10.6533 0-2.9419-2.9418-2.9419-7.7115 0-10.6533 2.9418-2.9419 7.7115-2.9419 10.6533 0 2.9419 2.9418 2.9419 7.7115 0 10.6533z" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg><span class="DocSearch-Button-Placeholder">Search</span></span><span class="DocSearch-Button-Keys"><kbd class="DocSearch-Button-Key"><svg width="15" height="15" class="DocSearch-Control-Key-Icon"><path d="M4.505 4.496h2M5.505 5.496v5M8.216 4.496l.055 5.993M10 7.5c.333.333.5.667.5 1v2M12.326 4.5v5.996M8.384 4.496c1.674 0 2.116 0 2.116 1.5s-.442 1.5-2.116 1.5M3.205 9.303c-.09.448-.277 1.21-1.241 1.203C1 10.5.5 9.513.5 8V7c0-1.57.5-2.5 1.464-2.494.964.006 1.134.598 1.24 1.342M12.553 10.5h1.953" stroke-width="1.2" stroke="currentColor" fill="none" stroke-linecap="square"></path></svg></kbd><kbd class="DocSearch-Button-Key">K</kbd></span></button></div>
            ...
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3">
                        <a href="https://github.com/twbs/bootstrap/releases/download/v5.3.3/bootstrap-5.3.3-examples.zip" class="btn btn-lg bd-btn-lg btn-bd-primary d-flex align-items-center justify-content-center fw-semibold" onclick="ga('send', 'event', 'Examples', 'Hero', 'Download Examples');">
                            <svg class="bi me-2" aria-hidden="true"><use xlink:href="#box-seam"></use></svg>
                            Download examples
                        </a>
                        <a href="https://github.com/twbs/bootstrap/archive/v5.3.3.zip" class="btn btn-lg bd-btn-lg btn-outline-secondary" onclick="ga('send', 'event', 'Examples', 'Hero', 'Download');">
                ...
                <div class="col-xl-4 d-lg-flex justify-content-xl-end">
                    <script async="" src="https://cdn.carbonads.com/carbon.js?serve=CKYIKKJL&amp;placement=getbootstrapcom" id="_carbonads_js"></script><div id="carbonads"><span>
                            ...
                            <span class="carbon-wrap">
                                <a href="https://srv.carbonads.net/ads/click/x/GTND427WCVBDT53NF6YLYKQUCEYIE5Q7F6YIVZ3JCABD453NCTYIE53KCE7DCKQ7CY7I6K3EF6SDVK7LCAYD42JKC6SIVKJWCKSDTK3EHJNCLSIZ" class="carbon-img" target="_blank" rel="noopener sponsored">
                                    <img src="https://srv.carbonads.net/static/30242/4f7f59796c5dda8f5dfc63a40583dfde7cebb050" alt="ads via Carbon" border="0" height="100" width="130" data-no-statview="no" style="max-width: 130px;">
                                </a>
                                <a href="https://srv.carbonads.net/ads/click/x/GTND427WCVBDT53NF6YLYKQUCEYIE5Q7F6YIVZ3JCABD453NCTYIE53KCE7DCKQ7CY7I6K3EF6SDVK7LCAYD42JKC6SIVKJWCKSDTK3EHJNCLSIZ" class="carbon-text" target="_blank" rel="noopener sponsored">
    ...
    <main class="bd-content order-1 py-5" id="content">
        <div class="container-xxl bd-gutter">
            ...
            <div class="bd-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-3 d-flex gap-3">
                        ...
                        <div>
                            <h3 class="h5 mb-1">
                                <a class="d-block link-offset-1" href="https://github.com/twbs/examples/tree/main/starter/" target="_blank" rel="noopener">
                                    CDN starter
                                </a>
                            </h3>
                            <p class="text-body-secondary">Instantly include Bootstrap's compiled CSS and JavaScript via the jsDelivr CDN.</p>
                            <p>
                                <a class="icon-link small link-secondary link-offset-1" href="https://stackblitz.com/github/twbs/examples/tree/main/starter?file=index.html" target="_blank" rel="noopener">
                    ...
                    <div class="col-md-6 col-lg-4 mb-3 d-flex gap-3">
                        ...
                        <div>
                            <h3 class="h5 mb-1">
                                <a class="d-block link-offset-1" href="https://github.com/twbs/examples/tree/main/sass-js/" target="_blank" rel="noopener">
                                    Sass &amp; JS
                                </a>
                            </h3>
                            ...
                            <p>
                                <a class="icon-link small link-secondary link-offset-1" href="https://stackblitz.com/github/twbs/examples/tree/main/sass-js?file=index.html" target="_blank" rel="noopener">
                                    <svg class="bi flex-shrink-0"><use xlink:href="#lightning-charge-fill"></use></svg>
                                    Edit in StackBlitz
                                </a>
                            </p>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3 d-flex gap-3">
                        ...
                        <div>
                            <h3 class="h5 mb-1">
                                <a class="d-block link-offset-1" href="https://github.com/twbs/examples/tree/main/sass-js-esm/" target="_blank" rel="noopener">
                                    Sass &amp; ESM JS
                                </a>
                            </h3>
                            ...
                            <p>
                                <a class="icon-link small link-secondary link-offset-1" href="https://stackblitz.com/github/twbs/examples/tree/main/sass-js-esm?file=index.html" target="_blank" rel="noopener">
                                    <svg class="bi flex-shrink-0"><use xlink:href="#lightning-charge-fill"></use></svg>
                                    Edit in StackBlitz
                                </a>
                            </p>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3 d-flex gap-3">
                        ...
                        <div>
                            <h3 class="h5 mb-1">
                                <a class="d-block link-offset-1" href="https://github.com/twbs/examples/tree/main/parcel/" target="_blank" rel="noopener">
                                    Parcel
                                </a>
                            </h3>
                            <p class="text-body-secondary">Import and bundle Bootstrap's source Sass and JavaScript via Parcel.</p>
                            <p>
                                <a class="icon-link small link-secondary link-offset-1" href="https://stackblitz.com/github/twbs/examples/tree/main/parcel?file=src%2Findex.html" target="_blank" rel="noopener">
                                    <svg class="bi flex-shrink-0"><use xlink:href="#lightning-charge-fill"></use></svg>
                                    Edit in StackBlitz
                                </a>
                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/headers/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/headers.png,
                                 /docs/5.3/assets/img/examples/headers@2x.png 2x" src="/docs/5.3/assets/img/examples/headers.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Headers
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/heroes/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/heroes.png,
                                 /docs/5.3/assets/img/examples/heroes@2x.png 2x" src="/docs/5.3/assets/img/examples/heroes.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Heroes
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/features/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/features.png,
                                 /docs/5.3/assets/img/examples/features@2x.png 2x" src="/docs/5.3/assets/img/examples/features.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Features
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/sidebars/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/sidebars.png,
                                 /docs/5.3/assets/img/examples/sidebars@2x.png 2x" src="/docs/5.3/assets/img/examples/sidebars.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Sidebars
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/footers/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/footers.png,
                                 /docs/5.3/assets/img/examples/footers@2x.png 2x" src="/docs/5.3/assets/img/examples/footers.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Footers
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/dropdowns/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/dropdowns.png,
                                 /docs/5.3/assets/img/examples/dropdowns@2x.png 2x" src="/docs/5.3/assets/img/examples/dropdowns.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Dropdowns
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/list-groups/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/list-groups.png,
                                 /docs/5.3/assets/img/examples/list-groups@2x.png 2x" src="/docs/5.3/assets/img/examples/list-groups.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                List groups
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/modals/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/modals.png,
                                 /docs/5.3/assets/img/examples/modals@2x.png 2x" src="/docs/5.3/assets/img/examples/modals.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Modals
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/badges/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/badges.png,
                                 /docs/5.3/assets/img/examples/badges@2x.png 2x" src="/docs/5.3/assets/img/examples/badges.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Badges
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/breadcrumbs/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/breadcrumbs.png,
                                 /docs/5.3/assets/img/examples/breadcrumbs@2x.png 2x" src="/docs/5.3/assets/img/examples/breadcrumbs.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Breadcrumbs
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/buttons/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/buttons.png,
                                 /docs/5.3/assets/img/examples/buttons@2x.png 2x" src="/docs/5.3/assets/img/examples/buttons.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Buttons
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/jumbotrons/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/jumbotrons.png,
                                 /docs/5.3/assets/img/examples/jumbotrons@2x.png 2x" src="/docs/5.3/assets/img/examples/jumbotrons.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Jumbotrons
                            </h3>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/album/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/album.png,
                                 /docs/5.3/assets/img/examples/album@2x.png 2x" src="/docs/5.3/assets/img/examples/album.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Album
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/pricing/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/pricing.png,
                                 /docs/5.3/assets/img/examples/pricing@2x.png 2x" src="/docs/5.3/assets/img/examples/pricing.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Pricing
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/checkout/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/checkout.png,
                                 /docs/5.3/assets/img/examples/checkout@2x.png 2x" src="/docs/5.3/assets/img/examples/checkout.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Checkout
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/product/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/product.png,
                                 /docs/5.3/assets/img/examples/product@2x.png 2x" src="/docs/5.3/assets/img/examples/product.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Product
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/cover/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/cover.png,
                                 /docs/5.3/assets/img/examples/cover@2x.png 2x" src="/docs/5.3/assets/img/examples/cover.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Cover
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/carousel/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/carousel.png,
                                 /docs/5.3/assets/img/examples/carousel@2x.png 2x" src="/docs/5.3/assets/img/examples/carousel.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Carousel
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/blog/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/blog.png,
                                 /docs/5.3/assets/img/examples/blog@2x.png 2x" src="/docs/5.3/assets/img/examples/blog.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Blog
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/dashboard/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/dashboard.png,
                                 /docs/5.3/assets/img/examples/dashboard@2x.png 2x" src="/docs/5.3/assets/img/examples/dashboard.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Dashboard
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/sign-in/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/sign-in.png,
                                 /docs/5.3/assets/img/examples/sign-in@2x.png 2x" src="/docs/5.3/assets/img/examples/sign-in.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Sign-in
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/sticky-footer/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/sticky-footer.png,
                                 /docs/5.3/assets/img/examples/sticky-footer@2x.png 2x" src="/docs/5.3/assets/img/examples/sticky-footer.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Sticky footer
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/sticky-footer-navbar/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/sticky-footer-navbar.png,
                                 /docs/5.3/assets/img/examples/sticky-footer-navbar@2x.png 2x" src="/docs/5.3/assets/img/examples/sticky-footer-navbar.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/jumbotron/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/jumbotron.png,
                                 /docs/5.3/assets/img/examples/jumbotron@2x.png 2x" src="/docs/5.3/assets/img/examples/jumbotron.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Jumbotron
                            </h3>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/starter-template/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/starter-template.png,
                                 /docs/5.3/assets/img/examples/starter-template@2x.png 2x" src="/docs/5.3/assets/img/examples/starter-template.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Starter template
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/grid/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/grid.png,
                                 /docs/5.3/assets/img/examples/grid@2x.png 2x" src="/docs/5.3/assets/img/examples/grid.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Grid
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/cheatsheet/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/cheatsheet.png,
                                 /docs/5.3/assets/img/examples/cheatsheet@2x.png 2x" src="/docs/5.3/assets/img/examples/cheatsheet.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Cheatsheet
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/cheatsheet-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/cheatsheet-rtl.png,
                                 /docs/5.3/assets/img/examples/cheatsheet-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/cheatsheet-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Cheatsheet RTL
                            </h3>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/navbars/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/navbars.png,
                                 /docs/5.3/assets/img/examples/navbars@2x.png 2x" src="/docs/5.3/assets/img/examples/navbars.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Navbars
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/navbars-offcanvas/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/navbars-offcanvas.png,
                                 /docs/5.3/assets/img/examples/navbars-offcanvas@2x.png 2x" src="/docs/5.3/assets/img/examples/navbars-offcanvas.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Navbars offcanvas
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/navbar-static/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/navbar-static.png,
                                 /docs/5.3/assets/img/examples/navbar-static@2x.png 2x" src="/docs/5.3/assets/img/examples/navbar-static.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Navbar static
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/navbar-fixed/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/navbar-fixed.png,
                                 /docs/5.3/assets/img/examples/navbar-fixed@2x.png 2x" src="/docs/5.3/assets/img/examples/navbar-fixed.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Navbar fixed
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/navbar-bottom/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/navbar-bottom.png,
                                 /docs/5.3/assets/img/examples/navbar-bottom@2x.png 2x" src="/docs/5.3/assets/img/examples/navbar-bottom.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Navbar bottom
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/offcanvas-navbar/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/offcanvas-navbar.png,
                                 /docs/5.3/assets/img/examples/offcanvas-navbar@2x.png 2x" src="/docs/5.3/assets/img/examples/offcanvas-navbar.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Offcanvas navbar
                            </h3>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/album-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/album-rtl.png,
                                 /docs/5.3/assets/img/examples/album-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/album-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Album RTL
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/checkout-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/checkout-rtl.png,
                                 /docs/5.3/assets/img/examples/checkout-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/checkout-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Checkout RTL
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/carousel-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/carousel-rtl.png,
                                 /docs/5.3/assets/img/examples/carousel-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/carousel-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Carousel RTL
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/blog-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/blog-rtl.png,
                                 /docs/5.3/assets/img/examples/blog-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/blog-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Blog RTL
                            </h3>
                        </a>
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/dashboard-rtl/" hreflang="ar">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/dashboard-rtl.png,
                                 /docs/5.3/assets/img/examples/dashboard-rtl@2x.png 2x" src="/docs/5.3/assets/img/examples/dashboard-rtl.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Dashboard RTL
                            </h3>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 mb-3">
                        <a class="d-block link-offset-1" href="/docs/5.3/examples/masonry/">
                            <img class="img-thumbnail mb-3" srcset="/docs/5.3/assets/img/examples/masonry.png,
                                 /docs/5.3/assets/img/examples/masonry@2x.png 2x" src="/docs/5.3/assets/img/examples/masonry.png" alt="" width="480" height="300" loading="lazy">
                            <h3 class="h5 mb-1">
                                Masonry
                            </h3>
                        </a>
            ...
            <div class="container">
                ...
                <img class="d-block img-fluid mt-3 mx-auto" srcset="/docs/5.3/assets/img/bootstrap-themes-collage.png,
                     /docs/5.3/assets/img/bootstrap-themes-collage@2x.png 2x" src="/docs/5.3/assets/img/bootstrap-themes-collage.png" alt="Bootstrap Themes" width="1150" height="320" loading="lazy">
            </div>
