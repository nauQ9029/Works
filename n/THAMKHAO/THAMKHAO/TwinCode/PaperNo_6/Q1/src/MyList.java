 ...
 Example: with the content given in the file 'data.txt', the content of 'f1.txt' after insertion 
    ...
    void f2() throws Exception {
        ...
        */
        ...
        Node temp = head;
        do{
            Apartment ap = temp.getInfo();
            if(ap.district.equals("Q2") || ap.district.equals("Q9"))
            {
                ap.setDistrict("TD");
                ap.setPrice(ap.price + 1);
            }
            temp = temp.next;
    ...
    void f3() throws Exception {
        ...
        */
        ...
        Node max = head;
        do{
            if(temp.getInfo().price > max.getInfo().price){
                max = temp;
            }
            temp = temp.next;
        }while(temp.next != null);
