  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{
            uri: "https://sp-ao.shortpixel.ai/client/to_auto,q_glossy,ret_img,w_1024,h_683/https://www.wyotech.edu/wp-content/uploads/2023/06/how-to-become-a-car-mechanic.jpg",
          }}
          style={styles.image}
        />
      ...
      <View style={styles.bottomBar}>
        <View style={{ flex: 1 }}>
          <Text style={styles.mechanicName}>Bùi Lê Việt Anh</Text>
          <Text style={styles.mechanicInfo}>34 tuổi - Ngũ Hành Sơn</Text>
        </View>
      ...
      <View style={styles.actionRow}>
        <TouchableOpacity style={styles.bookBtn}
          onPress={() => router.push("/customer/chooseLocation/chooseLocation")}>
